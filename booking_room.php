...
<body>
    ...
    <div class="card">
        <div class="header-card">
            <h3 class="text-left">ข้อมูลการจอง</h3><br>
            <div class="search-add">
                ...
                <div class="tab-func">
                    <input type="text" class="form-control search-name" placeholder="ค้นหาด้วยรหัสห้อง/ชื่อผู้จอง"
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td>มณฑิกา แก้วระย้า</td>
                        <td>15/02/2025-18/02/2025</td>
                        <td>001</td>
                        <td>ห้องพัก</td>
                        <td>1200 บาท/คืน</td>
                        ...
                        <td class="btn-action1">
                            ...
                            &nbsp;&nbsp;
                            <a href="#" class="btn btn-primary btn-sm primary-btn"
                                data-id="<?php echo $row['id']; ?>"><i class="fa-solid fa-file-invoice-dollar"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>ศศิกัญญา วรสวัสดิ์</td>
                        <td>15/02/2025-18/02/2025</td>
                        <td>001</td>
                        <td>เต็นท์</td>
                        <td>150 บาท/คน</td>
